...
const ShopCard = ({product}) => {
    ...
    return (
        <>
            <Link to={`/shop/`+product._id} className='bg-background_2 h-full border overflow-hidden shadow-xl hover:scale-105 duration-500'>
                <div className='relative'>
                    <img className='mix-blend-multiply' alt='tshirt' src={product?.images[0]?.url} />
